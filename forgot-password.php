...
<title><?php echo $settings_name; ?> | Forgot password</title>
            ...
            <div class="card card-outline card-primary mt-5">
              ...
              <div class="card-body">
                ...
                <form action="processes.php" method="post">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <button type="submit" class="btn bg-gradient-primary btn-block"  name="search" id="create_admin">Search</button>
                    </div>
                  </div>
                </form>
                <p class="mt-3 mb-1">
