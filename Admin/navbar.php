...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center"> 
    <?php 
      ...
      if(mysqli_num_rows($fetchpic) > 0) {
        while ($pic = mysqli_fetch_array($fetchpic)) {
          echo '<img class="animation__shake" src="../images-customization/'.$pic['logo'].'" alt="BMSLogo" height="105" width="105">';
        }
      } else {
        echo '<img class="animation__shake" src="../images/AB.png" alt="BMSLogo" height="105" width="105">';
      }
    ?>
  </div> 
 ...
 -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- Sidebar Menu -->
      <nav class="mt-4" style="line-height: 3px;">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="category.php" class="nav-link"><i class="fa-solid fa-puzzle-piece"></i><p>&nbsp;&nbsp; Manage Category</p></a>
          </li>
          <li class="nav-item">
            <a href="product.php" class="nav-link"><i class="fa-solid fa-bag-shopping"></i><p>&nbsp;&nbsp; Manage Products</p></a>
          </li>

          <li class="nav-header text-secondary">SYSTEM USERS</li>
          <li class="nav-item">
            <a href="admin.php" class="nav-link"><i class="fa-solid fa-users-gear"></i><p>&nbsp;&nbsp; Administrators</p></a>
          </li>
          <li class="nav-item">
            <a href="seller.php" class="nav-link"><i class="fa-sharp fa-solid fa-users"></i><p>&nbsp;&nbsp; Sellers</p></a>
          </li>
          <li class="nav-item">
            <a href="users.php" class="nav-link"><i class="fa-solid fa-users-line"></i><p>&nbsp;&nbsp; Buyers</p></a>
          </li>

          <!-- <li class="nav-header text-secondary">ANNOUNCEMENT</li>
          <li class="nav-item">
            <a href="announcement.php" class="nav-link"><i class="fa-solid fa-bell"></i><p>&nbsp;&nbsp; Announcement</p></a>
          </li> -->

          <li class="nav-header text-secondary">WEBSITE SETTINGS</li>
          <li class="nav-item">
            <a href="customize.php" class="nav-link"><i class="fa-solid fa-gear"></i><p>&nbsp;&nbsp; Settings</p></a>
          </li>
