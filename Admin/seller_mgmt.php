...
<title><?php echo $settings_name; ?> | Seller info</title>
              ...
              <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Seller photo</b></span>
                              <div class="input-group">
                ...
                <div class="card-footer">
                  <div class="float-right">
                    <a href="seller.php" class="btn bg-secondary"><i class="fa-solid fa-backward"></i> Back to list</a>
                    <button type="submit" class="btn bg-primary" name="create_seller" id="create_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                  </div>
                </div>
              </div>
            </form>
          ...
          <form action="process_update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
              ...
              <div class="card-footer">
                <div class="float-right">
                  <a href="seller.php" class="btn bg-secondary"><i class="fa-solid fa-backward"></i> Back to list</a>
                  <button type="submit" class="btn bg-primary" name="update_seller" id="create_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                </div>
              </div>
            </div>
          </form>
