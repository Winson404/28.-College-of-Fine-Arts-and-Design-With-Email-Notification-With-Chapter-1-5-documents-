...
<title><?php echo $settings_name; ?> | Buyer records</title>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Buyer records</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header p-2">
                <a href="users_mgmt.php?page=create" class="btn btn-sm bg-primary ml-2"><i class="fa-sharp fa-solid fa-square-plus"></i> New Buyer</a>
              ...
              <div class="card-body p-3">
                 ...
                 <table id="example1" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM users WHERE user_type = 'Buyer' ");
