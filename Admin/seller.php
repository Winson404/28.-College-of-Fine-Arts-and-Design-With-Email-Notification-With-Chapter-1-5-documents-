...
<title><?php echo $settings_name; ?> | Seller records</title>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Seller records</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header p-2">
                <a href="seller_mgmt.php?page=create" class="btn btn-sm bg-primary ml-2"><i class="fa-sharp fa-solid fa-square-plus"></i> New Seller</a>
              ...
              <div class="card-body p-3">
                 ...
                 <table id="example1" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM users WHERE user_type = 'Seller' ");
                    ...
                    <tr>
                        ...
                        <td>
                          <a class="btn btn-primary btn-sm" href="seller_view.php?user_Id=<?php echo $row['user_Id']; ?>"><i class="fas fa-folder"></i> View</a>
                          <a class="btn btn-info btn-sm" href="seller_mgmt.php?page=<?php echo $row['user_Id']; ?>"><i class="fas fa-pencil-alt"></i> Edit</a>
                    ...
                    <?php include 'seller_delete.php'; } } else { ?>
                      <tr>
