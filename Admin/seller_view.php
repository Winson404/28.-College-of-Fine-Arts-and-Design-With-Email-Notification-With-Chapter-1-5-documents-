...
<title><?php echo $settings_name; ?>| Seller's info</title>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Seller's info</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card">      
              ...
              <div class="card-footer float-right">
                <a href="seller.php" class="btn bg-secondary"><i class="fa-solid fa-circle-left"></i> Back to list</a>
                <a class="btn btn-info" href="seller_mgmt.php?page=<?php echo $row['user_Id']; ?>"><i class="fas fa-pencil-alt"></i> Edit</a>
              </div>
