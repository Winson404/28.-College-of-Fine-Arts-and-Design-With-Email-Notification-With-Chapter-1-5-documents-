...
<title><?php echo $settings_name; ?> | Administrator records</title>
                  ...
                  <tbody id="users_data">
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <?php if($row['user_type'] == 'Admin'): ?>
                          <a class="btn btn-primary btn-xs" href="admin_view.php?user_Id=<?php echo $row['user_Id']; ?>"><i class="fas fa-folder"></i> View</a>
                          <a class="btn btn-info btn-xs" href="admin_mgmt.php?page=<?php echo $row['user_Id']; ?>" style="pointer-events: none;opacity: .7;"><i class="fas fa-pencil-alt"></i> Edit</a>
