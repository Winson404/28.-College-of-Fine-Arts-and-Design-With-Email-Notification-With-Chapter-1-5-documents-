                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                    <div class="card bg-light d-flex flex-fill">
                      ...
                      <div class="card-footer">
                        ...
                        <p class="text-sm mb-0 float-left">Top price: <a href="#">₱<?php echo number_format($max_bid_price, 2, '.', ','); ?></a></p>
                        <p class="text-sm mb-0 float-right">Buyers: <a href="#"><?php echo $row['num_bids']; ?></a></p>
