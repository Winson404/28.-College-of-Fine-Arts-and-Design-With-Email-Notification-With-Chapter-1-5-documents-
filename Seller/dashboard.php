    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row d-flex justify-content-start">
          ...
          <?php 
            $fetch = mysqli_query($conn, "
                ...
                WHERE product.user_Id = '$id' AND product.product_status = 0
        ...
        <?php } else { ?>
          ...
          <?php 
            $fetch2 = mysqli_query($conn, "SELECT *, COUNT(bidding_Id) as num_bids FROM bidding JOIN product ON bidding.product_Id=product.product_Id JOIN category ON product.product_cat_Id=category.cat_id WHERE product.user_Id='$id' AND product.product_status=0 AND bidding.bidding_status=0 GROUP BY bidding.product_Id ORDER BY bidding.bidding_price DESC ");
        ...
        <?php } else { ?>
          ...
          <?php 
            $fetch3 = mysqli_query($conn, "SELECT *, COUNT(bidding_Id) as num_bids FROM bidding JOIN product ON bidding.product_Id=product.product_Id JOIN category ON product.product_cat_Id=category.cat_id WHERE product.user_Id='$id' AND product.product_status=1 AND bidding.bidding_status!=0 AND product.bid_due_date < '$date_today' GROUP BY bidding.product_Id ORDER BY bidding.bidding_price DESC ");
