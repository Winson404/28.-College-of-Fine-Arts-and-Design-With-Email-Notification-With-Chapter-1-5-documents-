...
<title><?php echo $settings_name; ?>| Bidder's info</title>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Bidder's info</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card">      
              <div class="card-body">
                  <div class="row p-2">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 text-dark">
                      ...
                      <p class="text-center text-sm text-muted">Buyer's photo</p>
                    </div>  
                  </div>
                  ...
                  <div class="row p-2">
                    <div class="col-lg-12 mt-3 mb-2 col-md-12 col-sm-12 col-12">
                      <a class="h5 text-primary"><b>Buyer address</b></a>
                      <div class="dropdown-divider"></div>
                    </div>
                      <div class="col-lg-12 col-md-6 col-12">
                          <div class="row">
              ...
              <div class="card-footer">
                <a href="product.php" class="btn bg-secondary float-right btn-sm"><i class="fa-solid fa-circle-left"></i> Back to list</a>
              </div>
