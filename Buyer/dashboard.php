  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"> On-going bidding products</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row d-flex justify-content-start">
          <?php 
            if(isset($_POST['search_button'])) {
              ...
              $fetch = mysqli_query($conn, "SELECT * FROM bidding JOIN product ON bidding.product_Id=product.product_Id JOIN category ON product.product_cat_Id=category.cat_id WHERE bidding.user_Id='$id' AND product.product_status=0 AND product.bid_due_date > '$date_today' AND product.product_name LIKE '%$search_product%' ORDER BY bidding.bidding_Id DESC ");
          ...
          <?php } } /*END OF IF ISSET FUNCTION*/
            ...
            $fetch = mysqli_query($conn, "SELECT * FROM bidding JOIN product ON bidding.product_Id=product.product_Id JOIN category ON product.product_cat_Id=category.cat_id WHERE bidding.user_Id='$id' AND product.product_status=0 AND product.bid_due_date > '$date_today' ORDER BY bidding.bidding_Id DESC ");
              if(mysqli_num_rows($fetch) > 0) {
                while ($row = mysqli_fetch_array($fetch)) {
                  $productId = $row['product_Id'];
                  $countdownId = "countdown-" . $productId;
